...
insert into assembly_order (id, shop_id, goods_id ,quantity, status, assembler, tracking_nr) values(2, 'shop 2', 'printer MK3 from H2Storage', 2, 'SHIPPED', '1', 'original_tracking_nr');
insert into assembly_user (id, role, name ,password) values(1, 'ASSEMBLER', 'John Doe', 'password');
insert into assembly_user (id, role, name ,password) values(5, 'SHOP', 'buyIt corp.', 'password');
insert into assembly_user (id, role, name ,password) values(9, 'ADMIN', 'IDo It', 'password');