...
insert into assembly_order (id, shop_order_id, goods_id ,quantity, status, metadata, assigned_to) values(4, '2O22/000472', 'printer MK3 from H2Storage', 2, 'CLAIMED', '{ "shipping address" : "nowhere"}', 4);
insert into assembly_order (id, shop_order_id, goods_id ,quantity, status, metadata, assigned_to) values(2, '2O22/000563', 'printer MK3 from H2Storage', 2, 'SHIPPED', '{ "shipping address" : "somewhere"}', 4);
