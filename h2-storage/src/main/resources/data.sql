...
insert into assembly_user (user_id, role, name ,password) values(2, 'SHOP', 'buyIt corp.', 'password');
insert into assembly_user (user_id, role, name ,password) values(3, 'ADMIN', 'IDo It', 'password');